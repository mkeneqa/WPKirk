...
Product::find([<span class="hljs-number">3</span>,<span class="hljs-number">4</span>]);</code></pre>
...
Product::find(<span class="hljs-number">3</span>)-&gt;activity;</code></pre>

  <pre><code class="hljs"><?php
var_dump(Product::find(3)->activity);
?></code></pre>
